...
export enum _SemanticTokenModifiers {
  ...
  Constructor = 'constructor', // java semanticTokenScopes rule
}
...
export type _SemanticTokenLegendItem = {
  tokenType: string;
  // todo: TBD actual modifiers: _SemanticTokenModifiers[];
...
export type ProviderValue<T> = T | undefined | null;
export type ProviderResult<T> = ProviderValue<T> | Promise<ProviderValue<T>>;
