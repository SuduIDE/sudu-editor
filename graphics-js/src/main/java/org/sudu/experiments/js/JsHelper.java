...
public class JsHelper {
  ...
  @JSBody(params = {
      "s0", "obj1", "s2", "obj3", "s4", "obj5"},
      script = "console.info(s0, obj1, s2, obj3, s4, obj5);")
  public static native void consoleInfo2(
      String s0, JSObject obj1,
      String s2, JSObject obj3,
      String s4, JSObject obj5
  );
