...
public class FileEncoding {
  ...
  public static boolean isGB2312_EUC_CN(byte[] bytes) {
...
//        return false;
  ...
  static boolean isBc1(byte b) {
    return (b & 0xc0) == 0x80;
  }

  static boolean isBc2(byte b) {
  ...
  public static void main(String[] args) {
    for (int i = 0; i < 256; i++) {
      byte b = (byte) i;
      boolean isBc1 = isBc1(b);
      boolean isBc2 = isBc2(b);
      if (isBc1 != isBc2) {
        System.out.println("i = " + i);
        System.out.println("isBc1 = " + isBc1);
        System.out.println("isBc2 = " + isBc2);
      }
    }
  }

  public static boolean isUtf8(byte[] text, boolean begin) {
