...
public class UniDiffModel extends Model0 {
  ...
  @Override
  void parseViewport(int firstLine, int lastLine) {
    // todo: translate line to local coordinates
//    model1.parseViewport(firstLine, lastLine);
//    model2.parseViewport(firstLine, lastLine);
  }
