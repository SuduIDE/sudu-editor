...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#classOrInterfaceBodyDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterClassOrInterfaceBodyDeclaration(JavaParser.ClassOrInterfaceBodyDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#classOrInterfaceBodyDeclaration}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#compilationUnitOrAny}.
	 * @param ctx the parse tree
	 */
	void enterCompilationUnitOrAny(JavaParser.CompilationUnitOrAnyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#compilationUnitOrAny}.
	 * @param ctx the parse tree
	 */
	void exitCompilationUnitOrAny(JavaParser.CompilationUnitOrAnyContext ctx);
