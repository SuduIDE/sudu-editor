// Generated from parser-generator/src/main/resources/grammar/typescript/LightTypeScriptLexer.g4 by ANTLR 4.13.1
package org.sudu.experiments.parser.typescript.gen;
...
public class LightTypeScriptLexer extends Lexer {
	...
	public static final int
		...
		Hashtag=29, LeftShiftArithmetic=30, LessThan=31, MoreThan=32, LessThanEquals=33, 
		GreaterThanEquals=34, Equals_=35, NotEquals=36, IdentityEquals=37, IdentityNotEquals=38, 
		BitAnd=39, BitXOr=40, BitOr=41, And=42, Or=43, MultiplyAssign=44, DivideAssign=45, 
		...
		BitXorAssign=53, BitOrAssign=54, PowerAssign=55, NullishCoalescingAssign=56, 
		ARROW=57, NullLiteral=58, BooleanLiteral=59, DecimalLiteral=60, HexIntegerLiteral=61, 
		...
		BigDecimalIntegerLiteral=68, Break=69, Do=70, Instanceof=71, Typeof=72, 
		Case=73, Else=74, New=75, Var=76, Catch=77, Finally=78, Return=79, Void=80, 
		Continue=81, For=82, Switch=83, While=84, Debugger=85, Function_=86, This=87, 
		With=88, Default=89, If=90, Throw=91, Delete=92, In=93, Try=94, As=95, 
		From=96, ReadOnly=97, Async=98, Await=99, Yield=100, YieldStar=101, Class=102, 
		Enum=103, Extends=104, Super=105, Const=106, Export=107, Import=108, Implements=109, 
		Let=110, Private=111, Public=112, Interface=113, Package=114, Protected=115, 
		Static=116, Any=117, Number=118, Never=119, Boolean=120, String=121, Unique=122, 
		Symbol=123, Undefined=124, Object=125, Of=126, KeyOf=127, TypeAlias=128, 
		Constructor=129, Namespace=130, Require=131, Module=132, Declare=133, 
		Abstract=134, Is=135, At=136, Identifier=137, StringLiteral=138, BackTick=139, 
		WhiteSpaces=140, LineTerminator=141, HtmlComment=142, CDataComment=143, 
		UnexpectedCharacter=144, TemplateStringEscapeAtom=145, TemplateStringStartExpression=146, 
		TemplateStringAtom=147;
	public static final int
		ERROR=2;
	public static final int
		TEMPLATE=1;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'as'", "'from'", "'readonly'", "'async'", "'await'", "'yield'", "'yield*'", 
			"'class'", "'enum'", "'extends'", "'super'", "'const'", "'export'", "'import'", 
			"'implements'", "'let'", "'private'", "'public'", "'interface'", "'package'", 
			"'protected'", "'static'", "'any'", "'number'", "'never'", "'boolean'", 
			"'string'", "'unique'", "'symbol'", "'undefined'", "'object'", "'of'", 
			"'keyof'", "'type'", "'constructor'", "'namespace'", "'require'", "'module'", 
			"'declare'", "'abstract'", "'is'", "'@'", null, null, "'`'", null, null, 
			null, null, null, null, "'${'"
		};
	}
	...
	public LightTypeScriptLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "LightTypeScriptLexer.g4"; }
