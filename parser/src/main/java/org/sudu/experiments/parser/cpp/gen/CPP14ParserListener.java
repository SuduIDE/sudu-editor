...
public interface CPP14ParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterUnknownInterval(CPP14Parser.UnknownIntervalContext ctx);
	/**
	 * Exit a parse tree produced by {@link CPP14Parser#unknownInterval}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterAnySeq(CPP14Parser.AnySeqContext ctx);
	/**
	 * Exit a parse tree produced by {@link CPP14Parser#anySeq}.
	 * @param ctx the parse tree
	 */
	void exitAnySeq(CPP14Parser.AnySeqContext ctx);
}