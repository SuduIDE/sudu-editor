// Generated from parser-generator\src\main\resources\grammar\javascript\JavaScriptParser.g4 by ANTLR 4.12.0
...
public interface JavaScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#programOrAny}.
	 * @param ctx the parse tree
	 */
	void enterProgramOrAny(JavaScriptParser.ProgramOrAnyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#programOrAny}.
	 * @param ctx the parse tree
	 */
	void exitProgramOrAny(JavaScriptParser.ProgramOrAnyContext ctx);

	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#unknownInterval}.
	 * @param ctx the parse tree
	 */
	void enterUnknownInterval(JavaScriptParser.UnknownIntervalContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#unknownInterval}.
	 * @param ctx the parse tree
	 */
	void exitUnknownInterval(JavaScriptParser.UnknownIntervalContext ctx);

	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#any}.
	 * @param ctx the parse tree
	 */
	void enterAny(JavaScriptParser.AnyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#any}.
	 * @param ctx the parse tree
	 */
	void exitAny(JavaScriptParser.AnyContext ctx);
}